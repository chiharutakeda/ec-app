...
const BASE_URL = "https://ec-app-6f50f.web.app"
...
const createCustomer = async (email, paymentMethodId, uid) => {
    ...
    const customerResponese = await response.json()
    return JSON.parse(customerResponese.body)
}
